...
},{"./config":1,"./lib/dom":5,"./lib/object":10,"./lib/ua":12,"./player/player":16}],3:[function(require,module,exports){
...
Player.prototype.bindVideoEvent = function(){
    ...
    Event.on(tag, 'error', function(e){
        ...
        {
            var errorFlag = 0;
            if(that._options.source.indexOf("flv") > 0 )
            {
                errorFlag = 1;
            }
            else
            {
                if(that._options.source.indexOf("m3u8") > 0 && !UA.IS_MOBILE)
                {
                    errorFlag = 1;
                }
            }
...
},{"../lib/dom":5,"../lib/event":6,"../lib/io":8,"../lib/object":10,"../lib/ua":12,"../monitor/monitor":15,"../ui/component":17,"../ui/exports":26}],17:[function(require,module,exports){
var oo = require('../lib/oo');
var Data = require('../lib/data');
var _ = require('../lib/object');
var Dom = require('../lib/dom');
...
},{"../lib/data":4,"../lib/dom":5,"../lib/event":6,"../lib/function":7,"../lib/layout":9,"../lib/object":10,"../lib/oo":11}],18:[function(require,module,exports){
/**
 * @fileoverview 大播放按钮
 */
...
},{"../../lib/dom":5,"../component":17}],19:[function(require,module,exports){
/**
 * @fileoverview 控制条组件
*/
var Component = require('../component');
...
},{"../../lib/util":14,"../component":17}],22:[function(require,module,exports){
/**
 * @fileoverview 播放按钮
 */
var Component = require('../component');
...
},{"../component":17}],23:[function(require,module,exports){
/**
 * @fileoverview 进度条
 */
var Component = require('../component');
...
},{"../../lib/dom":5,"../../lib/event":6,"../../lib/function":7,"../../lib/ua":12,"../component":17}],24:[function(require,module,exports){
/**
 * @fileoverview 播放时间
 */
var Component = require('../component');
...
},{"../../lib/util":14,"../component":17}],25:[function(require,module,exports){
/**
...
},{"./component/big-play-button":18,"./component/controlbar":19,"./component/fullscreen-button":20,"./component/live-display":21,"./component/play-button":22,"./component/progress":23,"./component/time-display":24,"./component/volume":25}]},{},[2]);
